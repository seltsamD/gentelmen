...
<head>
    ...
    <script src="<c:url value="${pageContext.request.contextPath}/resources/js/app.js" />"
            type="text/javascript"></script>
...
<div class="container">
    ...
    <div class="mainContent">
        <div class="topBox">
            ...
            <form:form cssClass="form-horizontal" id="myform"
                       action="/admin/addGood**?${_csrf.parameterName}=${_csrf.token}**" method="POST"
                       commandName="good" enctype="multipart/form-data">
                <form:hidden path="id"/>
                ...
                <div class="form-group">
                    <label for="categorySelect" class="col-sm-2 control-label"><spring:message
                            code="good.type"/></label>
                    <div class="col-sm-10">
                        <form:select id="categorySelect" cssClass="form-control" onchange="loadSecondLevel()" path="">
                ...
                <div class="form-group">
                    <label for="categorySelect" class="col-sm-2 control-label"><spring:message
                            code="good.type"/></label>
                    <div class="col-sm-10">
                        <form:select id="categoryChildren" path="category.id" cssClass="form-control">
                        </form:select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="file" name="file" multiple="true" id="fileId" onblur="count()"
                               class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <label for="nameUa" class="col-sm-2 control-label">Назва</label>
                    <div class="col-sm-10">
                        <form:textarea path="nameUa" cssClass="form-control"/>
                        <form:errors path="nameUa" cssClass="error-msg"/>
                    </div>
                </div>
                <div class="form-group">
                    <label for="nameRu" class="col-sm-2 control-label">Название</label>
                    <div class="col-sm-10">
                        <form:textarea path="nameRu" cssClass="form-control"/>
                        <form:errors path="nameRu" cssClass="error-msg"/>
                    </div>
                </div>
                <form:hidden path="description.id"/>
                <div class="form-group">
                    <label for="description.uaText" class="col-sm-2 control-label"><spring:message code="good.about"/>
                        українською</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                    <label for="description.ruText" class="col-sm-2 control-label"><spring:message code="good.about"/>
                        на русском</label>
                    <div class="col-sm-10">
                        <form:textarea path="description.ruText" cssClass="form-control"/>
                        <form:errors path="description.ruText" cssClass="error-msg"/>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-10">
                        ...
                        <c:if test="${good.id==0}">
                            <input type="button" value="<spring:message code="form.add"/>" id="btn-add"
                                   class="btn btn-success">
                        </c:if>
                        <c:if test="${good.id!=0}">
                            <input type="button" value="<spring:message code="form.edit"/>" id="btn-update"
        ...
        <table id="box-table-b" class="good-info">
            ...
            <c:forEach var="obj" items="${allData}">
                <tr>
                    <td><a class="single_image" href="<c:url value="/images/${obj.id}_0_mini.jpg"/>">
                        <img class="miniImg"
                             src="<c:url value="/images/${obj.id}_0_mini.jpg"/>"/></a>
                    </td>
                    ...
                    <c:if test="${lang_code == 'uaText'}">
                        <td><c:out value="${obj.nameUa}"/></td>
                    </c:if>
                    <c:if test="${lang_code == 'ruText'}">
                        <td><c:out value="${obj.nameRu}"/></td>
                    </c:if>


                    <td class="right_table"><a
                            href="${pageContext.request.contextPath}/admin/deleteGood?id=${obj.id}"><spring:message
                            code="form.delete"/> </a> |
                        <a href="${pageContext.request.contextPath}/admin/goodById?id=${obj.id}"><spring:message
                                code="form.edit"/></a> |
                        <a href="${pageContext.request.contextPath}/admin/goodInfo?id=${obj.id}"><spring:message
                                code="form.info"/></a>
                    </td>
                </tr>
                <tr>
...
<script src="<c:url value="${pageContext.request.contextPath}/resources/js/goodform.js" />"
        type="text/javascript"></script>
</body>
</html>
